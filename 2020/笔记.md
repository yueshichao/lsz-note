...
> 参考：[idea 查看sun包下源码](https://blog.csdn.net/rain_zhao_0102/article/details/106041697)

- git clone -b jdk8u/jdk8u/master --depth=1 https://github.com/openjdk-mirror/jdk.git

- 在IDEA中，导入源码 `File - Project Structure - SDKs - Sourcepath(左下角的+号)`

- 把刚刚clone的源码引入，源码在`jdk/src/share/classes`
