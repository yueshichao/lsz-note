...
## 简历
- 熟悉html、css等标签语言，使用过vue，js
- Java基础扎实，了解常用算法和数据结构，对JVM有一定的了解
- 使用并了解Spring，Spring Boot，jpa等框架
- 熟练编写SQL语句，了解InnoDB索引的实现
- 会使用Linux、Docker、Git基本命令
- 使用并了解kafka，Nginx，Redis，Elasticsearch等中间件
